export const ar = {
    ...
    contract: {
        modalTitle: 'إدارة العقد',
        statusSigned: 'موقع ومكتمل',
        statusPending: 'في انتظار توقيع العميل',
        downloadPdf: 'تحميل العقد PDF',
        refresh: 'تحديث',
        clientDetails: 'تفاصيل العميل',
        phone: 'الهاتف',
        cin: 'رقم البطاقة / الجواز',
        vehicleDetails: 'تفاصيل السيارة',
        plate: 'اللوحة',
        rates: 'السعر',
        total: 'المجموع',
        clientLinkTitle: 'رابط توقيع العميل الرقمي',
        clientLinkDesc: 'أرسل هذا الرابط الآمن والفريد للعميل عبر الرسائل أو الواتساب ليتمكن من فتح وتوقيع عقد الإيجار مباشرة من هاتفه الذكي.',
        copy: 'نسخ',
        copied: 'تم النسخ!',
        open: 'فتح',
        shareWhatsApp: 'مشاركة عبر الواتساب',
        lessorSectionTitle: 'ختم وتوقيع المؤجر / الوكالة',
        saveConfig: 'حفظ الإعدادات',
        lessorDesc: 'قم بتحميل ختم وتوقيع وكالتك (صور PNG شفافة). سيتم حفظها على متصفحك وإدراجها تلقائيًا في عقود PDF.',
        agencyStamp: 'ختم الوكالة',
        adminSignature: 'توقيع الإدارة',
        clear: 'مسح',
        uploadStamp: 'رفع الختم',
        drawSignatureHere: 'ارسم التوقيع هنا',
        clientSignatureImage: 'صورة توقيع العميل',
        verifiedDigitalSignature: 'توقيع رقمي موثق',
        publicTitle: 'عقد إيجار سيارة',
        publicSigned: 'عقد موقع رقمياً',
        publicSignedOn: 'تم التوقيع بتاريخ',
        publicRequired: 'التوقيع مطلوب',
        publicRequiredDesc: 'يرجى مراجعة التفاصيل أدناه والتوقيع أسفل الصفحة.',
        ...
        termsTitle: 'شروط وقواعد الإيجار:',
        term1: 'يجب إرجاع السيارة في التاريخ المحدد وبنفس مستوى الوقود.',
        term2: 'يتعهد السائق باحترام جميع قوانين وأنظمة المرور المحلية.',
        term3: 'مبلغ الضمان {deposit} درهم قابل للاسترداد بعد فحص حالة السيارة.',
        digitalSignatureRecord: 'سجل التوقيع الرقمي',
        signHere: 'وقع هنا (بإصبعك أو بالفأرة)',
        downloadSignedPdf: 'تحميل العقد الموقع PDF',
        confirmAndSign: 'تأكيد وتوقيع العقد',
        submittingSignature: 'جاري إرسال التوقيع...',
        systemFooter: 'نظام إدارة تأجير السيارات • عقد رقمي آمن',
        contractNumber: 'عقد رقم {number}',
        viewContract: 'عرض العقد الموقع',
        manageContract: 'إدارة العقد والرابط',

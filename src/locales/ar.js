export const ar = {
    ...
    auth: {
        ...
        registerSubtitle: 'قم بإنشاء حساب مسؤول جديد للوصول إلى لوحة القيادة',
        registerButton: 'تسجيل',
        registering: 'جاري إنشاء الحساب...',
        noAccount: 'ليس لديك حساب؟',
        registerLink: 'قم بإنشاء حساب الآن',
        hasAccount: 'لديك حساب بالفعل؟',
        loginLink: 'سجل الدخول هنا',
        userExists: 'اسم المستخدم موجود بالفعل. يرجى اختيار اسم آخر.',
